...
#
# Created: Fri Jan 29 14:06:07 2016
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btnSend.setGeometry(QtCore.QRect(770, 620, 211, 61))
        font = QtGui.QFont()
        ...
        self.btnSendFile.setGeometry(QtCore.QRect(770, 330, 211, 41))
        self.btnSendFile.setObjectName(_fromUtf8("btnSendFile"))
        self.btnSetting = QtGui.QPushButton(Dialog)
        self.btnSetting.setGeometry(QtCore.QRect(770, 450, 211, 41))
        self.btnSetting.setObjectName(_fromUtf8("btnSetting"))
        self.btnMediaMeeting = QtGui.QPushButton(Dialog)
        self.btnMediaMeeting.setGeometry(QtCore.QRect(770, 390, 211, 41))
        self.btnMediaMeeting.setObjectName(_fromUtf8("btnMediaMeeting"))
        self.lableShow = QtGui.QLabel(Dialog)
        self.lableShow.setGeometry(QtCore.QRect(10, 660, 751, 21))
        self.lableShow.setText(_fromUtf8(""))
        self.lableShow.setObjectName(_fromUtf8("lableShow"))

        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        Dialog.setTabOrder(self.editPwd, self.editChid)
        Dialog.setTabOrder(self.editChid, self.editSvrAddr)
        Dialog.setTabOrder(self.editSvrAddr, self.editInput)
        Dialog.setTabOrder(self.editInput, self.btnSend)
        Dialog.setTabOrder(self.btnSend, self.btnConnectSvr)
        Dialog.setTabOrder(self.btnConnectSvr, self.btnContactList)
        Dialog.setTabOrder(self.btnContactList, self.btnSendFile)
        Dialog.setTabOrder(self.btnSendFile, self.btnMediaMeeting)
        Dialog.setTabOrder(self.btnMediaMeeting, self.btnSetting)
        Dialog.setTabOrder(self.btnSetting, self.editInfo)
        Dialog.setTabOrder(self.editInfo, self.editOutput)
